...
export default function CreateOrphanage() {
  ...
  const [instructions, setIsntructions] = useState('')
        ...
        <form onSubmit={handleSubmit} className="create-orphanage-form">
            ...
            <div className="input-block">
              ...
              <div className="images-container">
                {previewImages.map(image => {
                  return (
                    <img key={String(image)} src={String(image)} alt={name}/>
                  )
                })}
          ...
          <fieldset>
            ...
            <div className="input-block">
              ...
              <textarea id="instructions" value={instructions} onChange={e => setIsntructions(e.target.value)}/>
            </div>
